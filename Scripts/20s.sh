...
# 环境变量定义
readonly LOG_PATH="/home/ubuntu20/Workspace/Datasets/Multimodal/20s"  # 结果保存路径
readonly HPC_PATH="/home/ubuntu20/Workspace/Datasets/Multimodal/20s/8Events"  # HPC结果保存路径 /home/ubuntu20/Workspace/Datasets/Multimodal/20s/8Events/B_1.txt && M_1.txt
readonly SNAPSHOT_PATH="/home/ubuntu20/Workspace/Datasets/Multimodal/20s/Snapshots"  # SNAPSHOT结果保存路径 /home/ubuntu20/Workspace/Datasets/Multimodal/20s/Snapshots/B/B_1/ck1
...
get_data() {
    ...
    local duration_time="20s"  # 执行和采集数据的持续时间(秒)
    ...
    # 构建perf命令
    perf_cmd="timeout --signal=SIGINT ${duration_time} perf stat -e $EVENTS -I 200 -G $group_args -o $hpc_result"
