...
readonly HPC_PATH="/home/ubuntu20/Workspace/Datasets/Multimodal/20s/8Events"  # HPC结果保存路径
readonly SNAPSHOT_PATH="/home/ubuntu20/Workspace/Datasets/Multimodal/20s/Snapshots"  # SNAPSHOT结果保存路径
