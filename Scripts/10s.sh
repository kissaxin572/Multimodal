...
readonly HPC_PATH="/home/ubuntu20/Workspace/Datasets/Multimodal/10s/8Events"  # HPC结果保存路径 /home/ubuntu20/Workspace/Datasets/Multimodal/10s/8Events/B_1.txt && M_1.txt
readonly SNAPSHOT_PATH="/home/ubuntu20/Workspace/Datasets/Multimodal/10s/Snapshots"  # SNAPSHOT结果保存路径  /home/ubuntu20/Workspace/Datasets/Multimodal/10s/Snapshots/B/B_1/ck1
...
get_data() {
    ...
    # 构建perf命令
    perf_cmd="timeout --signal=SIGINT ${duration_time} perf stat -e $EVENTS -I 100 -G $group_args -o $hpc_result"
