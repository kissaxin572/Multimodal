...
log_file_path = "Logs/log_10s.txt"  # 定义日志文件路径
...
def hpc():
    input_dirs = "Datasets/Original/10s/8Events"
    output_file = "Datasets/Processed/10s/10s_100ms.csv"
...
def b2image():
    input_base_folder = "Datasets/Original/10s/Snapshots"
    output_base_folder = "Datasets/Processed/10s"
